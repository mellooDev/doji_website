...
import './Header.scss';
import logo from '../../resources/img/logo-doji.png'
                                    ...
                                    <ul className="nav navbar-nav center_nav pull-right">
                                        <li className="nav-item">
                                            <NavLink exact to="/" className="nav-link"
                                                activeClassName="selected" activeStyle={{ color: '#da2032' }}>
                                                Trang chủ
                                            </NavLink>
                                        </li>
                                        <li className="nav-item ">
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/about" className="nav-link" activeClassName="selected" activeStyle={{
                                                color: "#da2032"
                                            }}>
                                                Giới thiệu
                                            </NavLink>
